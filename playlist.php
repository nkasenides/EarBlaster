...
<meta charset="utf-8">
<title><?php include("php/getPlaylistName.php");?> - EarBlaster</title>
<?php 
...
<div class="content">
    ...
    <?php 
		if (isset($_GET["status"])) {
			$status = $_GET["status"];
			if ($status == "error") {
				echo '<p class="error"> Could not delete track from playlist. </p>';
			}//fail
			else if ($status == "ok") {
				echo '<p class="success"> Track deleted. </p>';
			}//success
		}//end is isset()
	?>
    ...
    <div class="trackBlock">
    	...
    	<?php include("php/displayPlaylist.php");?>
    </div><!--end trackblock-->
